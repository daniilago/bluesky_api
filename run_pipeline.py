...
def run_analysis(data: dict) -> dict:
    ...
    # Etapa 4: Métricas de rede 
    print("[4/7] Métricas de rede e centralidade ")
    ...
    # Etapa 6: Sentimento 
    print("[6/7] Análise de sentimento por comunidade ")
...
def run_analysis_with_pdf(data: dict) -> str:
    """Roda o pipeline completo e gera o PDF."""
    ...
    report_path = generate_report(
        ...
        comm_summary_df=results["comm_summary_df"],
        top_terms=results["top_terms"],
        recommendations=results["recommendations"],
        network_image=results["imgs"]["network"],
        wordcloud_images=results["imgs"]["wordclouds"],
        basic_props=results["basic_props"],
        centrality_df=results["centrality_df"],
        sentiment_summary_df=results["sentiment_summary_df"],
        imgs=results["imgs"],
    )
